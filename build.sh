...
do
  ...
  do
    ...
    do
      ...
      scons useExecutionEnvironment=yes logLevel=warning logLevel0=info parallelization=hybrid scalasca=none compileMode=release arch=$ARCH compiler=$TOOL order=$ORDER -j 32 
